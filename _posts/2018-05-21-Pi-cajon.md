...
utilizzare anche altri tipi di suoni (un tamburello, un clap, un wind chimes..), ecco la definizione di **"cajon aumentato"**.
...
È da sottolineare come tutte le scelte ai punti sopra devono essere fatte in **"tempo reale"**. Questo aspetto ha condizionato molte delle decisioni prese durante la realizzazione del progetto.
